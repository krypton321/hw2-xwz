...
public class AnnotatorType_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.deiis.types.AnnotatorType");
  ...
  public String getMark(int addr) {
      ...
      jcas.throwFeatMissing("Mark", "edu.cmu.deiis.types.AnnotatorType");
  ...
  public String getGene(int addr) {
      ...
      jcas.throwFeatMissing("Gene", "edu.cmu.deiis.types.AnnotatorType");
